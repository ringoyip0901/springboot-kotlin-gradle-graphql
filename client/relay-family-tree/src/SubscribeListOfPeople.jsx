...
const loadSubscription = () => {
    const subscriptionConfig = {
        ...
        updater: proxyStore => {
            ...
            // const connectToFamily = ConnectionHandler.getConnection(newFamilyTree, "SubscribeListOfPeople_allPeople")
...
export default createPaginationContainer (
    ...
    {
        allPeople: graphql`
            fragment SubscribeListOfPeople_allPeople on AllPeople {
                allPeople (
                    first: 10000,
                ) {
                    edges {
